...
describe('common usage', () => {
  it('works correctly for common operations', () => {
    ...
    ).toBe('"\\u0066\\u006F\\u006F\\u0000\\u0062\\u0061\\u0072\\uFFFD\\u0062\\u0061\\u007A"');
    expect(
      jsesc({ 'foo\x00bar\uFFFDbaz': 'foo\x00bar\uFFFDbaz' }, {
        'escapeEverything': true,
        'json': true
      })
    ).toBe('{"\\u0066\\u006F\\u006F\\u0000\\u0062\\u0061\\u0072\\uFFFD\\u0062\\u0061\\u007A":"\\u0066\\u006F\\u006F\\u0000\\u0062\\u0061\\u0072\\uFFFD\\u0062\\u0061\\u007A"}');
    expect(
      jsesc(['foo\x00bar\uFFFDbaz', 'foo\x00bar\uFFFDbaz'], {
        'escapeEverything': true,
        'json': true
    ...
    expect(
      jsesc(tmp, { 'json' : true })
    ).toBe('{"hello":"world","\\uD83D\\uDCA9":"foo","pile":"\\uD83D\\uDCA9"}');
    expect(
      jsesc(tmp)
    ).not.toBe('{"hello":"world","\\uD83D\\uDCA9":"foo","pile":"\\uD83D\\uDCA9"}');
    expect(
      jsesc([42, 42n], {
        'numbers': 'hexadecimal',
        'lowercaseHex': true
