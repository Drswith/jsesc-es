...
function forOwn(object: any, callback: (key: string, value: any) => void) {
...
function isBuffer(value: any) {
  return Buffer && Buffer.isBuffer && Buffer.isBuffer(value)
}
...
// For compatibility, also export version (will be set during build)
